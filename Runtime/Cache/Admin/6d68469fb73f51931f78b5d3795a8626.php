...
<link href="/webone/Public/admin/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>

<link href="/webone/Public/admin/css/daterangepicker.css" rel="stylesheet" type="text/css" />

<link href="/webone/Public/admin/css/fullcalendar.css" rel="stylesheet" type="text/css"/>

<link href="/webone/Public/admin/css/jqvmap.css" rel="stylesheet" type="text/css" /webone/Public/admin="screen"/>

<link href="/webone/Public/admin/css/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" /webone/Public/admin="screen"/>
    ...
    <div class="navbar-inner">
        ...
        <div class="container-fluid">
            ...
            <a class="brand" href="index.html">
                ...
                <img src="/webone/Public/admin/image/logo.png" alt="logo"/>
            ...
            <a href="javascript:;" class="btn-navbar collapsed" data-toggle="collapse" data-target=".nav-collapse">
                ...
                <img src="/webone/Public/admin/image/menu-toggler.png" alt="" />
            ...
            <ul class="nav pull-right">
                    ...
                    <!--<ul class="dropdown-menu extended inbox">-->
                        ...
                        <!--<li>-->
                            ...
                            <!--<a href="inbox.html?a=view">-->
                                ...
                                <!--<span class="photo"><img src="/webone/Public/admin/image/avatar2.jpg" alt="" /></span>-->
                        ...
                        <!--<li>-->
                            ...
                            <!--<a href="inbox.html?a=view">-->
                                ...
                                <!--<span class="photo"><img src=".//webone/Public/admin/image/avatar3.jpg" alt="" /></span>-->
                        ...
                        <!--<li>-->
                            ...
                            <!--<a href="inbox.html?a=view">-->
                                ...
                                <!--<span class="photo"><img src=".//webone/Public/admin/image/avatar1.jpg" alt="" /></span>-->
                ...
                <li class="dropdown user">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img alt="" src="/webone/Public/admin/image/avatar1_small.jpg" />
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo U('Base/logout');?>"><i class="icon-key"></i> Log Out</a></li>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    <form action="<?php echo U('Set/basiced');?>" class="form-horizontal" method="post">
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="control-group">

                            <label class="control-label"><?php echo ($list["l_title"]); ?></label>
                                <input type="hidden" value="<?php echo ($list["l_id"]); ?>" name="<?php echo ($list["l_id"]); ?>[l_id]">
                            <div class="controls">
                                <?php if($list['l_type'] == 3): ?><textarea class="span6 m-wrap" rows="3" name="<?php echo ($list["l_id"]); ?>[l_value]"><?php echo ($list["l_value"]); ?></textarea>

                                <?php elseif($list['l_type'] == 2): ?>
                                        <?php echo ($list["l_value"]); ?>
                                <?php elseif($list['l_type'] == 1): ?>
                                    <input type="text" class="span6 m-wrap" name="<?php echo ($list["l_id"]); ?>[l_value]" value="<?php echo ($list["l_value"]); ?>" /><?php endif; ?>

                                <span class="help-inline"><?php echo ($list["l_name"]); ?></span>
