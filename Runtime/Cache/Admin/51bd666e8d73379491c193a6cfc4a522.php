...
<div class="page-container">
 ...
 <div class="container-fluid">
    ...
    <div class="row-fluid" >
        <div class="banner1" style="width: 50%; float: left;">
             <iframe src="banner1.html"   frameborder="0" scrolling="no"  width="80%" height="1000px"></iframe>
        </div>
        <div style="float: right;">
            <h3>更换图片：</h3>
            <form action="<?php echo U('Set/bannered');?>" method="post" enctype="multipart/form-data" id="myForm">
                <?php if(is_array($img)): $i = 0; $__LIST__ = $img;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?><span><img src="/webone/Public/<?php echo ($img["b_img"]); ?>" width="100px ">no.<?php echo ($img["b_id"]); ?>：<input type="file" name="img<?php echo ($img["b_id"]); ?>"></span><br/><span style="border: 1px black solid">删除</span><br /><?php endforeach; endif; else: echo "" ;endif; ?>

                <button class="btn-blue" type="submit" style="margin: 1rem">SAVE</button><button class="bth" type="reset" style="margin-left: 5rem">重置</button>
            </form>
        </div>
    </div>
